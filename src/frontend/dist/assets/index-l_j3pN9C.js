...
function CountUp({ value, className = "" }) {
  ...
  const prefix2 = value.replace(/\d.*/, "");
  const suffix2 = value.replace(/^[^\d]*\d+/, "");
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    const duration = 2e3;
    const steps2 = 60;
    const stepTime = duration / steps2;
    let current = 0;
    const timer = setInterval(() => {
      current += numericVal / steps2;
      if (current >= numericVal) {
        setDisplayed(value);
        clearInterval(timer);
      } else {
        setDisplayed(`${prefix2}${Math.floor(current)}${suffix2}`);
      }
    }, stepTime);
    return () => clearInterval(timer);
  }, [started, numericVal, value, prefix2, suffix2]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ref, className, children: displayed });
}
function CustomCursor() {
  const dotRef = reactExports.useRef(null);
  const ringRef = reactExports.useRef(null);
  const mouse = reactExports.useRef({ x: -100, y: -100 });
  const ring = reactExports.useRef({ x: -100, y: -100 });
  const animId = reactExports.useRef(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: isHover && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
              ...
              transform: phase === "subtitle" || phase === "fadeout" ? "translateY(0)" : "translateY(10px)",
              transition: "opacity 0.6s ease, transform 0.6s ease",
              userSelect: "none"
            },
            children: "DARK PSYCHOLOGY ATLAS"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
  ...
  reactExports.useEffect(() => {
    ...
    const initStars = () => {
      stars = Array.from({ length: 200 }, () => ({
        ...
        twinkleSpeed: Math.random() * 9e-3 + 2e-3,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { style: { display: "flex", gap: "40px" }, className: "hidden md:flex", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: l.href,
            "data-ocid": "nav.link",
            ...
            onMouseLeave: (e) => setColor(e.currentTarget, "rgba(232,232,232,0.7)"),
            children: l.label
          },
          l.label
        )) }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: 100, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                    fontFamily: "'Cormorant Garamond', serif",
                  ...
                  children: "Dark Psychology Atlas · Understanding the Mind"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollReveal, { delay: 200, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Where shadows meet science"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: 400, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "20px", flexWrap: "wrap" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: "#tactics",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: 600, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                onMouseEnter: (e) => {
                  ...
                  el.style.boxShadow = "0 0 20px rgba(201,169,110,0.7), 0 0 40px rgba(201,169,110,0.3), inset 0 0 16px rgba(201,169,110,0.1)";
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "of manipulation victims"
                    }
                  )
                ]
              }
...
function MarqueeBanner() {
  const marqueeText = "Manipulation · Dark Triad · Gaslighting · Coercive Control · NLP · Emotional Abuse · Cognitive Bias · Love Bombing · Narcissism · Fear Tactics · ";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: ["first", "second"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
                fontFamily: "'Cormorant Garamond', serif",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "16", r: "4", fill: "#c9a96e", opacity: "0.4" })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "20", r: "3", fill: "#c9a96e", opacity: "0.4" })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "12", y: "12", width: "8", height: "8", fill: "#c9a96e", opacity: "0.4" })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "16", r: "6", fill: "#c9a96e", opacity: "0.3" })
      ]
    }
  );
}
const tactics = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircIcon, {})
  }
];
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollReveal, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                  ...
                  children: "Understanding the arsenal of psychological control is the first step toward freedom. Each tactic below has been studied, documented, and weaponized — by understanding them, you reclaim your power."
                }
              ) })
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: tactics.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: i * 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: "24px" }, children: t.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                      style: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "32", cy: "21", r: "4", fill: "#c9a96e", opacity: "0.25" })
      ]
    }
  );
}
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollReveal, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Want to explore the depths of dark psychology, manipulation, and psychic awareness with us? Join the podcast and let's have a real conversation."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: "CALL TO JOIN"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "20px" }, children: "+91 97111 92390" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: 250, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                      ...
                      children: "Dark Psychology Talks"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Conversations that go beyond the surface — into the shadow side of the human mind."
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: [1, 2, 3, 4, 5].map((bar) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollReveal, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "blockquote",
                {
                  ...
                  children: "“The universe speaks in silence. Those gifted with the Clairs hear what others cannot — and see what the eyes will never reach.”"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "10px" }, children: clairs.map((clair) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
                      fontFamily: "'Cormorant Garamond', serif",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  style: {
                    ...
                    lineHeight: 1.1,
                    margin: "0 0 8px",
                    textShadow: "0 0 18px rgba(212,175,55,0.9), 0 0 40px rgba(212,175,55,0.5), 0 0 80px rgba(212,175,55,0.3)",
                    letterSpacing: "0.05em"
                  },
                  children: "Prisha Singh"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Game Developer · Editor · Psychic"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "I am Prisha Singh — a game developer, video editor, and psychic. I have created over 50+ games and have been learning video editing since I was 10. Today, I am a professional editor."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "I had strange experiences when I was a kid, but I couldn't understand what was happening. Then I discovered that I have natural psychic abilities, and it all started making sense to me. I have a connection with the universe. My abilities allow me to receive information and feelings from my angels, souls, archangels, and ascended masters. I can predict with accuracy. I can see, hear, feel, sense, and have intuitions beyond the boundaries of the physical world. I believe predictions can show you the way and give you directions. But remember, a prediction isn't an absolute outcome that is set in stone."
                }
              )
            ] })
          ]
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: i * 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountUp, { value: s.value })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
...
function ProtectSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", marginBottom: "80px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
              ...
              children: "HOW TO SHIELD YOUR MIND"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { delay: i * 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
...
function QuoteSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: "900px", margin: "0 auto" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "blockquote",
          {
            ...
            children: "In the digital world, your mind is the most targeted asset. Those who understand dark psychology rule — those who don't, are ruled."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "cite",
...
function VisitorSignupSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollReveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "20px", marginTop: "1px", flexShrink: 0 }, children: "🔒" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      style: {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { fontWeight: 600, color: "rgba(201,169,110,1)" }, children: "I promise you — this is a safe space." }),
                        " ",
                        "I'm Prisha, and I built this site because I genuinely care about awareness and truth. I'm not here to collect your data or sell your name. I simply want to know who is walking this path alongside me. No spam, no third-party sharing — just a name, kept close and respected. You have my word."
                      ]
                    }
                  )
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Introduce yourself. Your identity remains yours — we simply want to know who walks through these doors."
              }
            ),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      style: {
                        ...
                        color: "#c9a96e",
                        textShadow: "0 0 30px rgba(201,169,110,0.6), 0 0 60px rgba(201,169,110,0.3)",
                        marginBottom: "16px",
                        textTransform: "uppercase"
                      },
                      children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Your presence has been noted."
                    }
                  )
                ]
              }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Decoding the hidden forces of the human mind. Your guide to understanding dark psychology, manipulation tactics, and the art of protection."
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  "div",
                  {
                    ...
                    children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        ...
                        onMouseEnter: (e) => setColor(e.currentTarget, "#c9a96e"),
                        onMouseLeave: (e) => setColor(e.currentTarget, "rgba(232,232,232,0.45)"),
                        children: link
                      },
                      link
                    ))
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    onMouseEnter: (e) => setColor(e.currentTarget, "#c9a96e"),
                    onMouseLeave: (e) => setColor(e.currentTarget, "rgba(232,232,232,0.45)"),
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#c9a96e", fontSize: "15px" }, children: "📞" }),
                      "+91 97111 92390"
                    ] })
                  }
                ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    onMouseLeave: (e) => setColor(e.currentTarget, "rgba(232,232,232,0.45)"),
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#c9a96e", fontSize: "15px" }, children: "𝕏" }),
                      "@Not_Prisha7"
                    ] })
                  }
                )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    ...
                    " NEXURA_VOYAGE. All rights reserved."
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                    ...
                    margin: 0,
                    textAlign: "right",
                    textShadow: "0 0 12px rgba(212,175,55,0.8), 0 0 30px rgba(212,175,55,0.4)",
                    letterSpacing: "0.08em"
                  },
                  children: "Lead Visionary & CEO — Prisha Singh & Caylus Laroche"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Creative Director — Kobayashi Kobori"
                }
              )
            ]
          }
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StarfieldCanvas, {}),
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(MarqueeBanner, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TacticsSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(PodcastSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AboutSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(StatsSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(QuoteSection, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(VisitorSignupSection, {})
              ] }),
...
Service({
  "getAllMessages": Func([], [Vec(Message)], ["query"]),
